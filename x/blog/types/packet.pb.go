...
type UpdatePostPacketAck struct {
	IsUpdated string `protobuf:"bytes,1,opt,name=isUpdated,proto3" json:"isUpdated,omitempty"`
}
...
func (m *UpdatePostPacketAck) GetIsUpdated() string {
	if m != nil {
		return m.IsUpdated
	}
	return ""
...
var fileDescriptor_d544876606a92415 = []byte{
	...
	,
}
...
func (m *UpdatePostPacketAck) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.IsUpdated) > 0 {
		i -= len(m.IsUpdated)
		copy(dAtA[i:], m.IsUpdated)
		i = encodeVarintPacket(dAtA, i, uint64(len(m.IsUpdated)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *UpdatePostPacketAck) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.IsUpdated = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipPacket(dAtA[iNdEx:])
